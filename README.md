...
Motion is a professional JUCE audio instrument plugin for macOS and iOS.

## Overview

This repository contains the complete implementation of the Motion instrument, including:
...
```bash
# Clone repository
git clone git@github.com:bretbouchard/motion-instrument.git
cd motion-instrument
...
Motion instrument for White Room.
...
./render_instrument.sh motion
```

## Repository Information

- **Repository**: https://github.com/bretbouchard/motion-instrument
