    ...
    switch (instrumentType)
    {
        case GiantInstrumentType::GiantStrings:
            return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
                .getChildFile("AetherGiant/presets/MotionAetherString");

        case GiantInstrumentType::GiantDrums:
            return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
                .getChildFile("AetherGiant/presets/MotionAetherGiantDrums");

        case GiantInstrumentType::GiantVoice:
            return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
                .getChildFile("AetherGiant/presets/MotionAetherGiantVoice");

        case GiantInstrumentType::GiantHorns:
            return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
                .getChildFile("AetherGiant/presets/MotionAetherGiantHorns");

        case GiantInstrumentType::GiantPercussion:
            return juce::File::getSpecialLocation(juce::File::userApplicationDataDirectory)
                .getChildFile("AetherGiant/presets/MotionAetherGiantPercussion");
