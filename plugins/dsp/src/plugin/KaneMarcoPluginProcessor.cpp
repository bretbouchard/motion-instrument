/*
  ==============================================================================
   ...
   MotionPluginProcessor.cpp
   Implementation of VST3/AU Plugin Processor

  ==============================================================================
*/

#include "plugin/MotionPluginProcessor.h"
...
//==============================================================================
const MotionPluginProcessor::ParameterInfo MotionPluginProcessor::parameterInfos[] = {
...
//==============================================================================
// MotionPluginProcessor
//==============================================================================

MotionPluginProcessor::MotionPluginProcessor()
...
//==============================================================================
void MotionPluginProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
    juce::ScopedLock lock(dspLock);
    dsp_.prepare(sampleRate, samplesPerBlock);
}

void MotionPluginProcessor::releaseResources()
{
    juce::ScopedLock lock(dspLock);
    dsp_.reset();
}

void MotionPluginProcessor::processBlock(juce::AudioBuffer<float>& buffer,
...
juce::AudioProcessorEditor* MotionPluginProcessor::createEditor()
{
...
//==============================================================================
// Parameters
int MotionPluginProcessor::getNumParameters()
{
    return TotalNumParameters;
}

float MotionPluginProcessor::getParameter(int index)
{
    switch (index)
    {
...
void MotionPluginProcessor::setParameter(int index, float value)
{
    switch (index)
    {
        case MasterVolume:
...
const juce::String MotionPluginProcessor::getParameterName(int index)
{
...
const juce::String MotionPluginProcessor::getParameterText(int index)
{
...
//==============================================================================
// State Management
void MotionPluginProcessor::getStateInformation(juce::MemoryBlock& destData)
{
    // Create state XML
    juce::XmlElement state("MotionState");
...
void MotionPluginProcessor::setStateInformation(const void* data, int sizeInBytes)
{
    // Parse state XML
...
//==============================================================================
// Channel Info
const juce::String MotionPluginProcessor::getInputChannelName(int channelIndex) const
{
    switch (channelIndex)
    {
        case 0: return "Left";
...
const juce::String MotionPluginProcessor::getOutputChannelName(int channelIndex) const
{
    switch (channelIndex)
    {
        case 0: return "Left";
...
bool MotionPluginProcessor::isInputChannelStereoPair(int index) const
{
    return index == 0;
}

bool MotionPluginProcessor::isOutputChannelStereoPair(int index) const
{
    return index == 0;
}
...
void MotionPluginProcessor::processMIDI(juce::MidiBuffer& midiMessages,
                                          std::vector<DSP::ScheduledEvent>& events)
{
...
{
    return new MotionPluginProcessor();
}
