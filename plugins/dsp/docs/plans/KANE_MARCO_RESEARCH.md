# Motion Marco Implementation Research

**Research Date:** 2025-12-25
**Project:** Motion Marco Hybrid Virtual Analog Synthesizer
...
**Motion Marco** is a hybrid virtual analog synthesizer combining traditional subtractive synthesis with FM capabilities and oscillator warp. After comprehensive analysis of 3 implementation approaches, **Approach A (Pure JUCE DSP)** is recommended as the optimal solution.
...
**Why Approach A is the best choice for Motion Marco:**
...
#### [ ] `include/dsp/MotionDSP.h` (4 hours)
**Description:** Main DSP class declaration
**Key Components:**
- `class MotionDSP : public juce::AudioProcessor`
...
#### [ ] `src/dsp/MotionDSP.cpp` (26 hours)
...
- `MotionDSP::prepareToPlay()`
- `MotionDSP::processBlock()` - Main render
...
#### [ ] `include/ffi/motion_ffi.h` (2 hours)
**Description:** C bridge interface header
**Key Functions:**
- Lifecycle: `motion_create()`, `motion_destroy()`, `motion_initialize()`
- Audio: `motion_process()`
- Parameters: `motion_get/set_parameter_value()`, `motion_get_parameter_count()`
- Modulation: `motion_set_modulation_slot()`, `motion_get_modulation_value()`
- Macros: `motion_set_macro_value()`, `motion_learn_macro()`
- Presets: `motion_save/load/validate_preset()`
- Factory Presets: `motion_get_factory_preset_count()`, `motion_load_factory_preset()`
- Utility: `motion_get_version()`, `motion_get_last_error()`

**Pattern:** Follow `LocalGalFFI.h` exactly (extern "C", opaque handles, const char* strings)

#### [ ] `src/ffi/motion_ffi.cpp` (6 hours)
**Description:** C bridge implementation
**Key Functions:**
- Opaque handle implementation: `struct MotionDSPInstance { MotionDSP* dsp; }`
- Lifecycle wrappers
...
**Implementation Pattern:** Copy from `LocalGalFFI.cpp` and adapt for Motion Marco

### Phase 3: Tests (12 hours)

#### [ ] `tests/dsp/MotionTests.cpp` (12 hours)
...
#### [ ] `presets/Motion/Init_Bass.json` (20 min)
**Category:** Bass
...
#### [ ] `presets/Motion/Acid_Bass.json` (20 min)
**Category:** Bass
...
#### [ ] `presets/Motion/FM_Sub.json` (20 min)
**Category:** Bass
...
#### [ ] `presets/Motion/Deep_Bass.json` (20 min)
**Category:** Bass
...
#### [ ] `presets/Motion/Saw_Lead.json` (20 min)
**Category:** Lead
...
#### [ ] `presets/Motion/Square_Lead.json` (20 min)
**Category:** Lead
...
#### [ ] `presets/Motion/FM_Bell.json` (20 min)
**Category:** Lead
...
#### [ ] `presets/Motion/Warp_Lead.json` (20 min)
**Category:** Lead
...
#### [ ] `presets/Motion/Evolution_Pad.json` (20 min)
**Category:** Pad
...
#### [ ] `presets/Motion/Space_Pad.json` (20 min)
**Category:** Pad
...
#### [ ] `presets/MotionMacro/Warm_Pad.json` (20 min)
**Category:** Pad
...
#### [ ] `presets/Motion/Pluck_Synth.json` (20 min)
**Category:** Keys
...
#### [ ] `presets/Motion/Electric_Piano.json` (20 min)
**Category:** Keys
...
#### [ ] `presets/Motion/Hard_Sync.json` (20 min)
**Category:** Keys
...
#### [ ] `presets/Motion/Atmosphere_FX.json` (20 min)
**Category:** FX
...
#### [ ] `presets/Motion/Alien_Texture.json` (20 min)
**Category:** FX
...
#### [ ] `presets/Motion/Glitch_Lead.json` (20 min)
...
#### [ ] `presets/Motion/Chaos_FM.json` (20 min)
**Category:** Experimental
...
#### [ ] `docs/plans/MOTION_MARCO_IMPLEMENTATION.md` (2 hours)
...
#### [ ] `docs/plans/MOTION_MARCO_PRESET_GUIDE.md` (1 hour)
**Description:** Sound design guide for Motion Marco
**Sections:**
...
**Changes:**
- Add `include/dsp/MotionDSP.h` to headers
- Add `src/dsp/MotionDSP.cpp` to sources
- Add `include/ffi/motion_ffi.h` to headers
- Add `src/ffi/motion_ffi.cpp` to sources
- Add `tests/dsp/MotionTests.cpp` to tests
- Create `MotionDSP` target (if separate build)
...
**Example:**
```cpp
// In MotionOscillator::processSample()
float warpedPhase = phase + (warp * std::sin(phase * 2.0 * juce::MathConstants<double>::pi));
// Tests now pass
```
...
float MotionOscillator::applyWarp(double phase) const
{
...
**Approach A (Pure JUCE DSP)** is the recommended implementation strategy for Motion Marco. It balances sound quality, performance, development time, and maintainability while meeting all user requirements.
