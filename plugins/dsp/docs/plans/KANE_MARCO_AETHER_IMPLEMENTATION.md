...
**Test:** `tests/dsp/MotionAetherTests.cpp` (ModalFilter tests)
...
**File:** `include/dsp/AetherDSP.h` (partial)
**Test:** `tests/dsp/MotionAetherTests.cpp` (ResonatorBank tests)
...
**File:** `include/dsp/AetherDSP.h` (partial)
**Test:** `tests/dsp/MotionAetherTests.cpp` (Exciter tests)
...
**File:** `include/dsp/AetherDSP.h` (partial)
**Test:** `tests/dsp/MotionAetherTests.cpp` (FeedbackLoop tests)
...
**Test:** `tests/dsp/MotionAetherTests.cpp` (Voice tests)
...
**File:** `include/ffi/motion_aether_ffi.h`
...
**File:** `src/ffi/motion_aether_ffi.cpp`
