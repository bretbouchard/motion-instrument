...
This collection of 30 production-quality factory presets showcases the unique capabilities of the Motion Marco Hybrid Virtual Analog Synthesizer. Each preset demonstrates specific features including:
...
For issues or questions about Motion Marco presets, please refer to:
- Main documentation: `docs/plans/MOTION_MARCO_RESEARCH.md`
- Implementation details: `docs/plans/MASTER_PLAN_MOTION_MARCO_FAMILY.md`
- Test suite: `tests/dsp/MotionTests.cpp`

## License

These presets are part of the Motion Marco synthesizer project and are subject to the same license terms.

---

**Motion Marco Design Team** 2025
