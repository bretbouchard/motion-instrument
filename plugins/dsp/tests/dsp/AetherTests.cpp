...
//==============================================================================
// Test Fixture
class MotionAetherTests : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(MotionAetherTests, ModalFilter_ImpulseResponseResonatesAtCorrectFrequency)
{
...
TEST_F(MotionAetherTests, ModalFilter_DecayTimeMatchesT60Specification)
{
...
TEST_F(MotionAetherTests, ModalFilter_NumericalStabilityWithDenormalPrevention)
{
...
TEST_F(MotionAetherTests, ModalFilter_DirectFormIICoefficientAccuracy)
{
...
TEST_F(MotionAetherTests, ModalFilter_ResetClearsStateVariables)
{
...
TEST_F(MotionAetherTests, Exciter_TriggerProducesNoiseBurst)
{
...
TEST_F(MotionAetherTests, Exciter_EnvelopeShapeMatchesADSR)
{
...
TEST_F(MotionAetherTests, Exciter_NoiseColorFilteringWorks)
{
...
TEST_F(MotionAetherTests, Exciter_VelocityScalingIsCorrect)
{
...
TEST_F(MotionAetherTests, Exciter_ReleaseFadesToZero)
{
...
TEST_F(MotionAetherTests, Feedback_DelayTimeIsAccurate)
{
...
TEST_F(MotionAetherTests, Feedback_FeedbackAmountIsCorrect)
{
...
TEST_F(MotionAetherTests, Feedback_SaturationSoftClips)
{
...
TEST_F(MotionAetherTests, Feedback_StabilityAtMaxFeedback)
{
...
TEST_F(MotionAetherTests, Feedback_DryWetMixWorks)
{
...
TEST_F(MotionAetherTests, Feedback_HardLimitAt095)
{
...
TEST_F(MotionAetherTests, Voice_NoteOnOffLifecycle)
{
...
TEST_F(MotionAetherTests, Voice_ExciterToResonatorPath)
{
...
TEST_F(MotionAetherTests, Voice_FeedbackLoopEnhancesResonance)
{
...
TEST_F(MotionAetherTests, Voice_PolyphonyWorks)
{
...
TEST_F(MotionAetherTests, Voice_VoiceStealingWorks)
{
...
TEST_F(MotionAetherTests, ResonatorBank_HarmonicModesAreIntegerMultiples)
{
...
TEST_F(MotionAetherTests, ResonatorBank_InharmonicModesUseGoldenRatio)
{
...
static MotionAetherTests motionMarcoAetherTests;
