/*
  ==============================================================================
    ...
    MotionAdvancedPhysicsTests.cpp
...
//==============================================================================
// Test Fixture
class MotionAdvancedPhysicsTests : public ::testing::Test
{
protected:
    void SetUp() override
    {
...
TEST_F(MotionAdvancedPhysicsTests, PerModeQ_HigherFrequenciesDampFaster)
{
...
TEST_F(MotionAdvancedPhysicsTests, PerModeQ_HarmonicsDampFaster)
{
...
TEST_F(MotionAdvancedPhysicsTests, PerModeQ_MaterialAffectsBrightness)
{
...
TEST_F(MotionAdvancedPhysicsTests, PerModeQ_DecayProfilesAreRealistic)
{
...
TEST_F(MotionAdvancedPhysicsTests, Dispersion_AffectsHighFrequencies)
{
...
TEST_F(MotionAdvancedPhysicsTests, Dispersion_ParameterIsSmooth)
{
...
TEST_F(MotionAdvancedPhysicsTests, Sympathetic_CouplingAffectsOutput)
{
...
TEST_F(MotionAdvancedPhysicsTests, BridgeImpedance_AffectsReflection)
{
...
TEST_F(MotionAdvancedPhysicsTests, Material_GuitarPresetHasCorrectModes)
{
...
TEST_F(MotionAdvancedPhysicsTests, Material_PianoPresetIsMoreResonant)
{
...
TEST_F(MotionAdvancedPhysicsTests, Material_OrchestralStringIsBrightest)
{
...
TEST_F(MotionAdvancedPhysicsTests, Integration_AllFeaturesWorkTogether)
{
...
TEST_F(MotionAdvancedPhysicsTests, Performance_CPUUsageIsReasonable)
{
