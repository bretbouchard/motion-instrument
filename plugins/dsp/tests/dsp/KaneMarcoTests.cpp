/*
  ==============================================================================
    ...
    TDD Test Suite for Motion Marco Hybrid Virtual Analog Synthesizer
...
//==============================================================================
// Motion Marco Test Suite
//==============================================================================

class MotionTests : public juce::UnitTest
{
public:
    MotionTests() : juce::UnitTest("Motion Marco DSP", "DSP") {}
    ...
    void runTest() override
    {
        ...
        beginTest("Preset System - Get Preset Info");
        {
            ...
            MotionDSP::PresetInfo info = dsp.getPresetInfo(json);
...
static MotionTests motionMarcoTests;
