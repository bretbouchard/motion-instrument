/*
  ==============================================================================
    ...
    MotionComprehensiveTest.cpp
    Created: January 13, 2026
    Author: Bret Bouchard

    Comprehensive test suite for Motion Marco Hybrid Virtual Analog Synthesizer

  ==============================================================================
*/

#include "../include/dsp/MotionPureDSP.h"
#include <iostream>
#include <cstdio>
#include <cmath>
#include <vector>
...
void processAudioInChunks(MotionPureDSP& synth, float* left, float* right, int numSamples, int bufferSize = 512) {
...
int main(int argc, char* argv[]) {
    std::cout << "\n========================================" << std::endl;
    std::cout << "Motion Comprehensive Test Suite" << std::endl;
    std::cout << "========================================" << std::endl;
