...
//  MotionPluginApp
//
//  View controller for Motion Marco AUv3 host app
//
...
class ViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        infoLabel.text = "Open this app in GarageBand, AUM, or other AUv3 host to use Motion Marco as an instrument plugin."
